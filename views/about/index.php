...
<section class="about-content-section py-5 bg-white">
    <div class="container">
...
<section class="mission-vision-section py-5 bg-light">
    <div class="container">
        <div class="row g-4">
            <div class="col-lg-6">
                <div class="mission-vision-card card h-100 border-0 shadow-sm">
            ...
            <div class="col-lg-6">
                <div class="mission-vision-card card h-100 border-0 shadow-sm">
                    <div class="card-body text-center p-4">
                        ...
                        <p class="mission-vision-text text-muted">
                            Trở thành đơn vị uy tín trong cộng đồng khởi nghiệp quốc gia vào năm 2030, đóng góp giá trị
...
<section class="values-section py-5 bg-white">
    <div class="container">
        <div class="row g-4">
...
<section class="stats-section py-5">
    <div class="container">
        <div class="row g-4">
            <div class="col-lg-3 col-md-6">
                <div class="stat-item card h-100 border-0 shadow-sm text-center p-4">
    ...
    <div class="container">
        <div class="row g-4">
            <div class="col-lg-4 col-md-6">
                <div class="contact-card card h-100 border-0 shadow-sm text-center p-4">
