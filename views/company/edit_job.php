        ...
        <div class="col-md-10">
            <div class="card edit-card">
                ...
                <div class="card-body edit-info">
                    ...
                    <form id="editJobForm"
                        action="index.php?page=edit_job&id=<?php echo htmlspecialchars($job['id']); ?>" method="POST">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="number" class="form-control" id="so_luong" name="so_luong" min="1"
                                value="<?php echo htmlspecialchars($job['so_luong'] ?? '1'); ?>" required>
                        ...
                        <div class="form-group mb-3">
                            ...
                            <select class="form-control" id="trang_thai" name="trang_thai">
                                <option value="1" <?php echo ($job['trang_thai'] ?? 1) == 1 ? 'selected' : ''; ?>>Đang
                                    tuyển</option>
                                <option value="0" <?php echo ($job['trang_thai'] ?? 1) == 0 ? 'selected' : ''; ?>>Đã
                                    đóng</option>
                            </select>
                        </div>
