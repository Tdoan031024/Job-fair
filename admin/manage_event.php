		...
		<div class="card">
			<div class="card-body">
				<form action="" id="manage-event">
					...
					<div class="form-group row">
						<div class="col-md-5">
							<label for="" class="control-label">Lịch trình</label>
					...
					<div class="form-group">
						<div class="form-check">
						  ...
						  <label class="form-check-label" for="type">
						    Sự kiện riêng tư (<i>Không hiển thị trên trang web</i>)
						  </label>
						</div>
					</div>
					<div class="form-group">
					...
					<div class="form-group row" <?php echo isset($payment_type) && $payment_type == 1 ? "style='display:none'" : '' ?>>
						<div class="col-md-5">
							<label for="" class="control-label">Phí đăng ký</label>
					...
					<div class="form-group row">
						<div class="col-md-5">
							<label for="" class="control-label">Số lượng sinh viên tối đa</label>
					...
					<div class="form-group">
						<label for="" class="control-label">Thêm hình ảnh</label>
						...
						<label for="chooseFile" id="choose"><strong>Chọn hình</strong></label>
							  <div id="drop">
							  	<?php 
							  		$images = array();
							  		if(isset($id)){
